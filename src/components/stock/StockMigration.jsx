...
import { Stock, Warehouse } from "@/entities/all";
      ...
      if (stockRecords.length === 0) {
        ...
        for (const part of parts.slice(0, 5)) { // Limit to first 5 parts for testing
          try {
            ...
            console.error(`Error creating stock for part ${part.id}:`, err);
            failed++;
          }
        }
      }
