...
export default function WarehouseSettings() {
  ...
  const warehouseToDeleteRef = useRef(null);
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        <AlertDialog open={!!warehouseToDelete || loading} onOpenChange={(open) => { if (!open && !loading) { warehouseToDeleteRef.current = null; setWarehouseToDelete(null); } }}>
